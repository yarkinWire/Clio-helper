...
class FetchProvider {
    ...
    call(args) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            const headers = Object.assign(Object.assign({}, this.headers), args.headers);
    ...
    get transaction() {
        if (this.extra.packed_trx) {
            switch (this.extra.compression) {
                ...
                case 'none': {
                    return exports.Serializer.decode({
                        data: this.extra.packed_trx,
                        type: exports.Transaction,
                    });
                }
                default: {
...
GetActionsResponse$1 = tslib.__decorate([
...
TransactionAuthSequence = tslib.__decorate([
...
TransactionTraceReceipt = tslib.__decorate([
...
TransactionTrace = TransactionTrace_1 = tslib.__decorate([
...
GetTransactionResponse$1 = tslib.__decorate([
...
class StateAPIv2 {
     ...
     */
    get_account(account, limit, skip) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            return this.client.call({
                method: 'GET',
    ...
    call(args) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = isV2 && this.v2Provider
                ? yield this.v2Provider.call(args)
                : yield this.v1Provider.call(args);
            const { json } = response;
...
AccountRamDelta = tslib.__decorate([
...
GetTransactionResponseAction = tslib.__decorate([
...
ActionDataHeader = tslib.__decorate([
...
GetActionsTotal = tslib.__decorate([
...
HealthService = tslib.__decorate([
...
HealthFeaturesStreaming = tslib.__decorate([
...
HealthFeaturesTables = tslib.__decorate([
...
HealthFeatures = tslib.__decorate([
...
HealthResponse = tslib.__decorate([
...
ApiUsageTotal = tslib.__decorate([
...
ApiUsageBucket = tslib.__decorate([
...
ApiUsageResponse = tslib.__decorate([
...
MissedBlocksStats = tslib.__decorate([
...
MissedBlocksResponse = tslib.__decorate([
...
ResourceUsageStats = tslib.__decorate([
...
ResourceUsagePercentiles = tslib.__decorate([
...
ResourceUsage = tslib.__decorate([
...
GetResourceUsageResponse = tslib.__decorate([
...
TotalResources = tslib.__decorate([
...
SelfDelegatedBandwidth = tslib.__decorate([
...
GetAccountResponse = tslib.__decorate([
...
GetCreatedAccountsResponse = tslib.__decorate([
    Struct.type('get_account_response')
...
exports.ExplorerDefinition = class ExplorerDefinition extends Struct {
    url(id) {
...
var Logo_1;
exports.Logo = Logo_1 = class Logo extends Struct {
    static from(data) {
        if (typeof data === 'string') {
...
class ChainDefinition {
    ...
    static from(data) {
        return new ChainDefinition(Object.assign(Object.assign({}, data), { explorer: data.explorer ? exports.ExplorerDefinition.from(data.explorer) : undefined, logo: data.logo ? exports.Logo.from(data.logo) : undefined }));
    }
    get name() {
...
exports.TelosAccountVoterInfo = class TelosAccountVoterInfo extends AccountVoterInfo {
};
tslib.__decorate([
    Struct.field(Int64)
], exports.TelosAccountVoterInfo.prototype, "last_stake", void 0);
exports.TelosAccountVoterInfo = tslib.__decorate([
    Struct.type('telos_account_voter_info')
], exports.TelosAccountVoterInfo);
exports.TelosAccountObject = class TelosAccountObject extends AccountObject {
};
tslib.__decorate([
    Struct.field(exports.TelosAccountVoterInfo, { optional: true })
], exports.TelosAccountObject.prototype, "voter_info", void 0);
exports.TelosAccountObject = tslib.__decorate([
    Struct.type('telos_account_object')
], exports.TelosAccountObject);
exports.WAXAccountVoterInfo = class WAXAccountVoterInfo extends AccountVoterInfo {
};
tslib.__decorate([
    Struct.field(Float64)
...
exports.WAXAccountVoterInfo = tslib.__decorate([
    Struct.type('wax_account_voter_info')
], exports.WAXAccountVoterInfo);
exports.WAXAccountObject = class WAXAccountObject extends AccountObject {
};
tslib.__decorate([
    Struct.field(exports.WAXAccountVoterInfo, { optional: true })
], exports.WAXAccountObject.prototype, "voter_info", void 0);
exports.WAXAccountObject = tslib.__decorate([
...
exports.PowerUpState = class PowerUpState extends Struct {
};
tslib.__decorate([
    Struct.field('uint8')
...
exports.Connector = class Connector extends Struct {
};
tslib.__decorate([
    Struct.field('asset')
...
exports.ExchangeState = class ExchangeState extends Struct {
};
tslib.__decorate([
    Struct.field('asset')
], exports.ExchangeState.prototype, "supply", void 0);
tslib.__decorate([
    Struct.field(exports.Connector)
...
exports.REXState = class REXState extends Struct {
    get reserved() {
...
exports.ChainId = class ChainId extends Checksum256 {
    static from(value) {
        if (isInstanceOf(value, this)) {
            return value;
        }
...
exports.ChainAlias = class ChainAlias extends UInt8 {
};
exports.ChainAlias = tslib.__decorate([
    TypeAlias('chain_alias')
], exports.ChainAlias);
exports.ChainIdVariant = class ChainIdVariant extends Variant {
    get chainId() {
        if (isInstanceOf(this.value, exports.ChainId)) {
            return this.value;
        }
...
exports.ChainIdVariant = tslib.__decorate([
    Variant.type('variant_id', [exports.ChainAlias, exports.ChainId])
...
var RequestFlags_1;
exports.AccountName = class AccountName extends Name {
};
exports.AccountName = tslib.__decorate([
    TypeAlias('account_name')
], exports.AccountName);
exports.PermissionName = class PermissionName extends Name {
};
exports.PermissionName = tslib.__decorate([
    TypeAlias('permission_name')
], exports.PermissionName);
exports.IdentityV2 = class IdentityV2 extends Struct {
};
tslib.__decorate([
    Struct.field(exports.PermissionLevel, { optional: true })
...
exports.IdentityV3 = class IdentityV3 extends Struct {
};
tslib.__decorate([
    Struct.field('name')
...
exports.RequestVariantV2 = class RequestVariantV2 extends Variant {
};
exports.RequestVariantV2 = tslib.__decorate([
    Variant.type('variant_req', [exports.Action, { type: exports.Action, array: true }, exports.Transaction, exports.IdentityV2])
], exports.RequestVariantV2);
exports.RequestVariantV3 = class RequestVariantV3 extends Variant {
};
exports.RequestVariantV3 = tslib.__decorate([
    Variant.type('variant_req', [exports.Action, { type: exports.Action, array: true }, exports.Transaction, exports.IdentityV3])
], exports.RequestVariantV3);
exports.RequestFlags = RequestFlags_1 = class RequestFlags extends UInt8 {
    get broadcast() {
...
exports.InfoPair = class InfoPair extends Struct {
};
tslib.__decorate([
    Struct.field('string')
...
exports.RequestDataV2 = class RequestDataV2 extends Struct {
};
tslib.__decorate([
    Struct.field(exports.ChainIdVariant)
], exports.RequestDataV2.prototype, "chain_id", void 0);
tslib.__decorate([
    Struct.field(exports.RequestVariantV2)
], exports.RequestDataV2.prototype, "req", void 0);
tslib.__decorate([
    Struct.field(exports.RequestFlags)
], exports.RequestDataV2.prototype, "flags", void 0);
tslib.__decorate([
    Struct.field('string')
], exports.RequestDataV2.prototype, "callback", void 0);
tslib.__decorate([
    Struct.field(exports.InfoPair, { array: true })
...
exports.RequestDataV3 = class RequestDataV3 extends Struct {
};
tslib.__decorate([
    Struct.field(exports.ChainIdVariant)
], exports.RequestDataV3.prototype, "chain_id", void 0);
tslib.__decorate([
    Struct.field(exports.RequestVariantV3)
...
exports.RequestSignature = class RequestSignature extends Struct {
};
tslib.__decorate([
    Struct.field('name')
...
const PlaceholderAuth = exports.PermissionLevel.from({
...
class SigningRequest {
    ...
    static identityAbi(version) {
        const abi = exports.Serializer.synthesize(this.identityType(version));
    ...
    static createSync(args, options = {}, abis = {}) {
            ...
            for (const key in args.info) {
                ...
                if (isOwn) {
                    ...
                    if (typeof value === 'string') {
                        ...
                        value = exports.Serializer.encode({ object: value });
                    }
        ...
        if (args.chainIds && args.chainId === null) {
            ...
            data.info.push({
                key: 'chain_ids',
                value: exports.Serializer.encode({ object: ids, type: { type: exports.ChainIdVariant, array: true } }),
            });
        }
    ...
    static fromTransaction(chainId, serializedTransaction, options = {}) {
        ...
        encoder.writeArray(exports.Serializer.encode({ object: id.chainVariant }).array);
    ...
    static fromData(data, options = {}) {
        ...
        const req = exports.Serializer.decode({ data: decoder, type: this.storageType(version) });
        let sig;
        if (decoder.canRead()) {
            sig = exports.Serializer.decode({ data: decoder, type: exports.RequestSignature });
        }
    ...
    getData() {
        return exports.Serializer.encode({ object: this.data }).array;
    }
    ...
    getSignatureData() {
        ...
        return exports.Serializer.encode({ object: this.signature }).array;
    }
    ...
    resolveActions(abis, signer) {
        return this.getRawActions().map((rawAction) => {
            ...
            if (signer) {
                const signerPerm = exports.PermissionLevel.from(signer);
                const resolve = (value) => {
                ...
                authorization = authorization.map((auth) => {
                    ...
                    return exports.PermissionLevel.from({ actor, permission });
                });
            }
    ...
    resolve(abis, signer, ctx = {}) {
        ...
        const actions = tx.actions.map((action) => {
            ...
            const data = exports.Serializer.encode({ object: action.data, type, abi });
            return exports.Action.from(Object.assign(Object.assign({}, action), { data }));
        });
        const transaction = exports.Transaction.from(Object.assign(Object.assign({}, tx), { actions }));
        let chainId;
        ...
        return new ResolvedSigningRequest(this, exports.PermissionLevel.from(signer), transaction, tx, chainId);
    }
    /**
        ...
        switch (req.variantName) {
            ...
            case 'identity': {
                if (this.version === 2) {
                    ...
                    if (id.permission) {
                        data = exports.Serializer.encode({ object: id });
                        authorization = [id.permission];
                    }
                    const action = exports.Action.from({
                        account: '',
                        name: 'identity',
                        authorization,
                        data,
                    ...
                    const data = exports.Serializer.encode({ object: { scope, permission }, type: exports.IdentityV3 });
                    const action = exports.Action.from({
                        account: '',
                        name: 'identity',
    ...
    getRawTransaction() {
        ...
        switch (req.variantName) {
            case 'transaction':
                return exports.Transaction.from(Object.assign({}, req.value));
            case 'action':
            case 'action[]':
            case 'identity':
                return exports.Transaction.from({
    ...
    setInfoKey(key, object, type) {
        ...
        if (typeof object === 'string' && !type) {
            ...
            data = exports.Serializer.encode({ object, type });
        }
    ...
    getInfoKey(key, type) {
        ...
        if (data) {
            if (type) {
                return exports.Serializer.decode({ data, type });
            }
            else {
...
class ResolvedSigningRequest {
    ...
    get serializedTransaction() {
        return exports.Serializer.encode({ object: this.transaction }).array;
    }
    get signingDigest() {
...
exports.IdentityProof = IdentityProof_1 = class IdentityProof extends Struct {
    static from(value) {
    ...
    static fromString(string) {
        ...
        return exports.Serializer.decode({ data, type: IdentityProof_1 });
    }
    ...
    verify(auth, currentTime) {
        ...
        return (now < this.expiration.toMilliseconds() &&
            exports.Authority.from(auth).hasPermission(this.recover()));
    }
    /**
     * Encode the proof to an `SYSIO` auth header string.
     */
    toString() {
        const data = exports.Serializer.encode({ object: this });
        return `SYSIO ${encode(data.array, false)}`;
    }
};
tslib.__decorate([
    Struct.field(exports.ChainId)
